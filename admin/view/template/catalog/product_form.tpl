...
<div id="content">
                      ...
                      <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tr id="option-value-row<?php echo $option_value_row; ?>">
                            ...
                            <td class="text-right"><select style="   visibility: hidden;" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][points_prefix]" class="form-control">
                            ...
                            <td class="text-right"><select style="   visibility: hidden;" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][weight_prefix]" class="form-control">
  ...
  <script type="text/javascript"><!--
      ...
      function addOptionValue(option_row) {
          ...
          html += '  <td class="text-right"><select style="   visibility: hidden;" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][points_prefix]" class="form-control">';
          html += '    <option value="+">+</option>';
          html += '    <option value="-">-</option>';
          html += '  </select>';
          ...
          html += '  <td class="text-right"><select style="   visibility: hidden;" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][weight_prefix]" class="form-control">';
          html += '    <option value="+">+</option>';
          html += '    <option value="-">-</option>';
          html += '  </select>';
