<?php
	...
	$url = "https://" . $_SERVER['HTTP_HOST'] . "/index.php?route=extension/payment/knet/success";
	//$url = "https://" . $_SERVER['HTTP_HOST'] . "/test/index.php?route=payment/knet/success";
	...
	//echo 'REDIRECT=' . 	$url_test;
	//	header("Location: " .  $url . $result_params);
	//	exit;
?>