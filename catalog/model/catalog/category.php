	...
	public function getCategory($category_id) {
		...
		return $query->row;
           ...
           public function search($search,$category_id){
               ...
               $query=$this->db->query("SELECT DISTINCT oc_product.minimum, oc_product.viewed, oc_product.price AS price, oc_product.image AS image, oc_product_description.name, oc_product_to_category.category_id,oc_product.product_id FROM  oc_product_description, oc_product , oc_product_to_category WHERE  
