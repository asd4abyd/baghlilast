        ...
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" pattern='[A-Za-z\\s]*' id="input-firstname" class="form-control " required />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" pattern='[A-Za-z\\s]*' id="input-lastname" class="form-control  " required />
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" pattern='[A-Za-z\\s]*' id="input-company" class="form-control " />
            </div>
          </div>
