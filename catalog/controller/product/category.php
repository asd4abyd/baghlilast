    ...
    public function index() {
      ...
      //print_r($category_info);
        ...
        if ($category_info) {
            ...
            $data['go_cart'] = $this->language->get('go_cart');
...
$data['pageLink']=$this->url->link('product/category', '');
            ...
            $totalCategoryCount = $this->model_catalog_category->getTotalCategoriesWithSortSearch($dataCategoriesWithSortSearch);
            ...
            $product_total=$totalCategoryCount >0?$totalCategoryCount:$product_total;
            ...
            if (  false && isset($this->request->post['search'])  && $this->request->post['search']!= null) {
             ...
             //  echo $category_id;
                ...
                foreach ($results as $result) {
                    ...
                    //   $data ['options']= $this-> getProductOptions($result['product_id']);
                            ...
                            foreach ($option['product_option_value'] as $option_value) {
                                if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
                                    ...
                                    $product_option_value_data[] = array(
                                        ...
                                        'option_title'            => $option_value['points'],
                                        'option_description'      => $option_value['weight']
                                    );
                                }
                            }
...
//print_r($results);
            ...
            $data['sorts'][] = array(
                'text'  => $this->language->get('Most_Selling'),
                'value' => 'p.price-DESC',
            ...
            if ($this->config->get('config_review_status')) {
                $data['sorts'][] = array(
                    'text'  => $this->language->get('Most_Releated'),
                    'value' => 'rating-DESC',
            ...
            $data['sorts'][] = array(
                'text'  => $this->language->get('Best_Match'),
                'value' => 'p.model-ASC',
...
//            }
            ...
            $data['go_cart_link'] = $this->url->link('checkout/cart');
