...
print_r($status);//order_status_id
		...
		foreach ($results as $result) {
          ...
          //  $orderstatus11= $this->model_account_order->searchStatusOrder($data['orders']['order_id']);
            $orderstatus11= $this->model_account_order->searchStatusOrder($result['order_id']);
            $data['order_state'] = $orderstatus11;
          //  print_r($orderstatus11);
        }




		// $orderstatus = $this->model_account_order->getOrdersStatus();
        ...
        {
            $data['order_complete'] = $this->model_account_order->getOrdersStatusComplete();

            $this->response->setOutput( $this->load->view('account/order_com', $data));
        }elseif(isset($this->request->get['notcomplete'])){
